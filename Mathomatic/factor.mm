 ...
 */
int factor_divide(token_type	*equation,
				  int			*np,
				  long			v,
				  double		d)
{
 ...
 * Return true if equation side was modified.
 */
int subtract_itself(token_type	*equation,
					int			*np)
{
 ...
 * Return true if equation side was modified.
 */
int factor_plus(token_type	*equation,	/* pointer to beginning of equation side */
 ...
 * Return true if equation side was modified.
 */
static int fplus_recurse(token_type	*equation,
...
static int ftimes_recurse(token_type	*equation,
						  int		*np, int loc, int level)
{
	int	modified = false;
	int	i, j, k;
...
static int ftimes_sub(token_type	*equation,
					  int *np, int loc, int i1, int n1, int i2, int n2, int level)
{
	int	e1, e2;
	int	op1, op2;
	int	i, j, k;
 ...
 * Return true if equation side was modified.
 */
int factor_power(token_type	*equation,
				 int		*np)
{
	return fpower_recurse(equation, np, 0, 1);
}

static int fpower_recurse(token_type	*equation,
						  int		*np, int loc, int level)
{
	int	modified = false;
	int	i, j, k;
...
static int fpower_sub(token_type	*equation,
					  int *np, int loc, int i1, int n1, int i2, int n2, int level)
{
	int		e1, e2;
	int		op1, op2;
