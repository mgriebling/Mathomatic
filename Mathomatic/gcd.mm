 ...
 */
double my_round(double	d1)	/* value to round */
{
	if (d1 >= 0.0) {
		modf(d1 + 0.5, &d1);
	} else {
 ...
 */
int f_to_fraction(double	d,		/* floating point number to convert */
 ...
 */
int make_fractions(token_type	*equation,	/* equation side pointer */
 ...
 * Returns true if any fractions were created.
 */
int make_simple_fractions(token_type	*equation,	/* equation side pointer */
						  int			*np)		/* pointer to length of equation side */
{
	int	i, j, k;
	int	level;
 ...
 * Returns true if any fractions were created.
 */
int make_mixed_fractions(token_type	*equation,	/* equation side pointer */
						 int		*np)		/* pointer to length of equation side */
{
	int	i, j, k;
	int	level;
