...
long	n_equations,			/* number of equation spaces allocated */
...
/* string variables */
const char	*prog_name = "mathomatic";	/* name of this program */
...
long		result_en = -1;		/* equation number of the returned result, if stored in an equation space */
