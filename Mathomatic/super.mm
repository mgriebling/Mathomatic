...
static void group_recurse(token_type	*equation,	/* equation side pointer */
 ...
 */
void group_proc(token_type	*equation,	/* equation side pointer */
				int			*np)		/* pointer to length of equation side */
{
 ...
 */
int fractions_and_group(token_type	*equation,
						int		*np)
{
	int	rv = false;
 ...
 * Return true if any fractions were created.
 */
int make_fractions_and_group(int	n)	/* equation space number */
{
	int	rv = false;
 ...
 */
int super_factor(token_type	*equation,	/* pointer to the beginning of the equation side to process */
...
static int sf_recurse(token_type	*equation,
					  int			*np,  int loc,  int level,  int start_flag)
{
	int	modified = false;
	int	i, j, k;
	int	op;
...
static int sf_sub(token_type	*equation,
				  int		*np, int loc, int i1, int n1, int i2, int n2, int level, int start_flag)
{
	int		i, j, k;
	int		b1, b2;
	int		len;
