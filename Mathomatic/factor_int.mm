 ...
 */
int factor_int(token_type	*equation,
			   int			*np)
{
	int	i, j;
	int	xsize;
 ...
 */
int factor_int_equation(int	n)	/* equation space number */
{
	int	rv = false;
 ...
 */
int list_factor(token_type	*equation,
				int		*np,
				int		factor_flag)
{
 ...
 */
int factor_constants(token_type	*equation,	/* pointer to the beginning of equation side */
...
static int fc_recurse(token_type	*equation,
